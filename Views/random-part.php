...
// URLクエリパラメータを通じてIDが提供されたかどうかをチェック

use Database\MySQLWrapper;
use Helpers\HelperFunction;

$random_id = array_rand(HelperFunction::getIdsFromTable('computer_parts'));
...
?>
<!-- 上で宣言した$partをそのままレンダリングするhtml上で使用できる！ -->
